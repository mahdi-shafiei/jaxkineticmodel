class Jax_MM_Irrev_Uni:
    ...
    def __init__(self, substrate: str, vmax: str, km_substrate: str):
...
class Jax_MM_Irrev_Bi:
    def __init__(self, substrate1: str, substrate2: str, vmax: str, km_substrate1: str, km_substrate2: str):
        self.vmax = vmax
...
class Jax_Diffusion:
    ...
    def __init__(self, substrate: str, enzyme: str, transport_coef: str):
        self.substrate = substrate
        self.enzyme = enzyme
