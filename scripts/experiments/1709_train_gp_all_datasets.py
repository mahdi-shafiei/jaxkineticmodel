...
def main():
    ...
    glycolyse_GP1,time_points_GP1,y0_GP1,dataset_GP1=load_model_glucose_pulse_FF_datasets("FF1_timeseries_format.csv",dilution_rate="0.1",y0_dict=y0_dict)
    glycolyse_GP2,time_points_GP2,y0_GP2,dataset_GP2=load_model_glucose_pulse_FF_datasets("FF2_timeseries_format.csv",dilution_rate="0.1",y0_dict=y0_dict)
    glycolyse_GP3,time_points_GP3,y0_GP3,dataset_GP3=load_model_glucose_pulse_FF_datasets("FF3_timeseries_format.csv",dilution_rate="0.1",y0_dict=y0_dict)
    ...
    parameters_step_list=pd.DataFrame(parameters_step_list).to_csv(f"results/EXP4_Glycolysis_Fitting_Datasets/{date_today}_parameters_all_datasets_step50_{n_iter}.csv")
