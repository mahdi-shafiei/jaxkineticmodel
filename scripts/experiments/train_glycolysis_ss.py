...
from scripts.analysis_helper_functions.helper_function_glycolysis_analysis import prepare_glycolysis_model,update_parameters_by_dilution_rate
...
datasets={"SS_01":jnp.array(dataset_SS_01),"SS_05":jnp.array(dataset_SS_05),
...
time_points={"SS_01":jnp.array(time_points_SS_01),"SS_05":jnp.array(time_points_SS_05),
...
for step in range(400):
    ...
    for key in grads2.keys():
        grads[key]=(grads2[key]+grads3[key]+grads4[key]+grads5[key]+grads6[key]+grads7[key]+grads8[key]+grads9[key])/8
...
losses_per_iterations={"loss_per_iter2":loss_per_iter2,
...
losses_per_iterations_added.to_csv("results/EXP4_Glycolysis_Fitting_Datasets/1309_losses_ss_datasets_literature_parameter_init.csv")
